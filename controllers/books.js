...
async function ReadFile(file, col){
    ...
    return switchData(data, col);
}

async function WriteFile(file, col){
    await fs.writeFile(`${file}`, JSON.stringify({col:carti}))
};
